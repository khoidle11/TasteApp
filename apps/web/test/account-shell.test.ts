...
import { getWebAccountShellState } from "../src/account-shell.js";

describe("getWebAccountShellState", () => {
  it("describes the signed-out shell state", () => {
    expect(getWebAccountShellState(null)).toEqual({
